...
$lang = [
	...
	'explication_op_loader' => 'Allows replacing the <code>spip_loader.php</code> at the site root. That script installs whatever it is told to install: it is the most consequential permission you can grant remotely.',
	'explication_op_check' => 'Allows the <a href="https://git.spip.net/technova69/spip-check">SPIP Check</a> integrity checker to be dropped at the site root, and removed again. That tool reads the whole disk and can move files: it has its own access control, restricted to webmasters, but dropping it makes that power reachable from the web root. Remove it after use.',
	...
	'explication_op_waf' => 'Lets the control tower read the application firewall’s figures: blocked requests, banned addresses, reasons. This is security data, and it names visitors.',
	...
	'label_op_loader' => 'Update spip_loader.php',
	'label_op_check' => 'Deposit and remove spip_check.php',
	...
	'label_op_waf' => 'Read the SPIP WAF dashboard',
