...
function genie_dashboard_sync_dist($t) {
	...
	// être signalé comme en retard de core. L'annuaire officiel de spip.net
	// d'abord — c'est lui qui annonce les versions —, l'index d'archives ensuite
	// pour les miroirs qui n'ont pas d'annuaire.
